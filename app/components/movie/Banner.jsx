        ...
        <div className="movie-details flex flex-col justify-between py-8">
          <div className="movie-title">
            ...
            <h3 className="text-white text-xl">
              <b>{movie.age_rating}</b> | {convertDuration(movie.duration)} |{" "}
              {releaseYear}
            </h3>
          </div>
          <div className="movie-info flex flex-col gap-2">
            ...
            <div className="movie-cast text-white">
              <h3>
                <b>Cast:</b> {movie.movie_cast}
              </h3>
            </div>
          </div>
          <div className="movie-btns flex gap-4 w-full">
            <button className="movie-btn-buy bg-white font-bold px-4 py-2 rounded-md w-1/2">
              Buy Tickets
            </button>
            <button className="movie-btn-trailer text-white font-bold bg-[#ffffff00] px-4 py-2 rounded-md border-white border-2 w-1/2">
              Trailer
            </button>
          </div>
        </div>
